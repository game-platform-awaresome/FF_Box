//
//  FFBusinessRegistViewController.m
//  GameBox
//
...
@implementation FFBusinessRegistViewController

- (instancetype)init {
    return [[UIStoryboard storyboardWithName:@"MyStoryboard" bundle:nil] instantiateViewControllerWithIdentifier:@"FFBusinessRegistViewController"];
}
...
- (void)initUserInterface {
    ...
    self.registButton.backgroundColor = [FFColorManager blue_dark];
    self.registButton.layer.cornerRadius = self.registButton.bounds.size.height / 2;
    self.registButton.layer.masksToBounds = YES;
    [self.registButton setTitleColor:[FFColorManager navigation_bar_white_color] forState:(UIControlStateNormal)];
...
- (IBAction)respondsToAgreeButton:(id)sender {
